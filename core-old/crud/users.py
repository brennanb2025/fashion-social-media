...
from core.models.model import Users, Posts, MediaItems, Media, Items, Comments, Comment_likes, Post_likes
...
def create_user(db: Session, user: schema.UserCreate):
    ...
    bcrypt.get_hashed_password(user.password, bcrypt.gensalt(12))
